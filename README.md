...
| `pnpm lint` | Format-check and lint with Biome, check `tpl` template formatting, type-check, and run the elemix analyzer. |
| `pnpm lint:analyze` | Run the elemix analyzer over `src/` to validate components and bindings. |
